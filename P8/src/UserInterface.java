...
public class UserInterface extends JFrame implements ActionListener
{
    ...
    private JMenuItem mShift;
    private JMenuItem mSwap;
    private JLabel    mLabel;
    
    // P8.java object from student
    private P8 mStudent;
    ...
    protected void doAction (ActionEvent actionEvent) throws Exception {
        ...
        else if (src == mInvert)    	invert();
        else if (src == mExchange)		exchange();
        else if (src == mShift)    		shift();
    ...
    protected JMenu makeActionMenu() {
        ...
        mInvert     = makeMenuItem(menu, "Invert"     , 'I');
        mExchange   = makeMenuItem(menu, "Exchange"   , 'E');
        mShift      = makeMenuItem(menu, "Shift"      , 'F');
        mSwap		= makeMenuItem(menu, "Swap"       , 'W');
        return menu;
    }
